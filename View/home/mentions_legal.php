<h1 class="p-3 primetitle text-light">Mentions Légaux</h1>
<h2>Définitions</h2>
...
<p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est
    précisé aux users du site internet <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>
    l'identité des différents
...
<p>L’utilisation du site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> implique
    ...
    d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les users du site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> sont donc invités à les consulter de
    manière régulière.</p>
...
<p><a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> ne pourra être tenu responsable des
    dommages directs et indirects causés au matériel de l’user, lors de l’accès au site internet <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>, et résultant soit de l’utilisation
...
<p>En tant que responsable du traitement des données qu’il collecte, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> s’engage à respecter le cadre des
    dispositions légales en vigueur. Il lui Appartient notamment au Client d’établir les finalités de ses traitements
    de
...
<ul>
    ...
    <li class="mentions">pour permettre la navigation sur le Site et la gestion et la traçabilité des prestations et
        services commandés
        par l’user : données de connexion et d’utilisation du Site, facturation, historique des commandes, etc.
    </li>

    <li class="mentions">pour prévenir et lutter contre la fraude informatique (spamming, hacking…) : matériel
        informatique utilisé pour
        la navigation, l’adresse IP, le mot de passe (hashé) </li>

    <li class="mentions">pour améliorer la navigation sur le Site : données de connexion et d’utilisation </li>

    <li class="mentions">pour mener des enquêtes de satisfaction facultatives sur <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> : adresse email </li>
    <li class="mentions">pour mener des campagnes de communication (sms, mail) : numéro de téléphone, adresse email</li>
...
<p>
    Conformément à la réglementation européenne en vigueur, les users de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> disposent des droits suivants : </p>
<ul>

    <li class="mentions">droit d'accès (article 15 RGPD) et de rectification (article 16 RGPD), de mise à jour, de
    ...
    <li class="mentions">droit de retirer à tout moment un consentement (article 13-2c RGPD) </li>

    <li class="mentions">droit à la limitation du traitement des données des users (article 18 RGPD) </li>

    <li class="mentions">droit d’opposition au traitement des données des users (article 21 RGPD) </li>

    <li class="mentions">droit à la portabilité des données que les users auront fournies, lorsque ces données font
        l’objet de
        traitements automatisés fondés sur leur consentement ou sur un contrat (article 20 RGPD) </li>

    <li class="mentions">droit de définir le sort des données des users après leur mort et de choisir à qui <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> devra communiquer (ou non) ses
...
<p>Dès que <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> a connaissance du décès d’un
    user et à défaut d’instructions de sa part, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> s’engage à détruire ses données, sauf
    si leur conservation s’avère nécessaire à des fins probatoires ou pour répondre à une obligation légale.</p>

<p>Si l’user souhaite savoir comment <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>
    utilise ses Données Personnelles,
    demander à les rectifier ou s’oppose à leur traitement, l’user peut contacter <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> par écrit à l’adresse suivante : </p>

Mathieu Stamm – DPO, Mathieu Stamm <br>
10 avenue de Bruxelles 68350 BRUNSTATT-DIDENHEIM.

<p>Dans ce cas, l’user doit indiquer les Données Personnelles qu’il souhaiterait que <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> corrige, mette à jour ou supprime, en
...
<p>
    ...
    conservation ou d’archivage des documents. Enfin, les users de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> peuvent déposer une réclamation
...
<p>
    Les Données Personnelles de l’user peuvent être traitées par des filiales de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> et des sous-traitants (prestataires
...
<p>
    ...
    personnes susceptibles d’avoir accès aux données des users de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> sont principalement les agents de
...
<p>
    Aucune information personnelle de l'user du site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> n'est publiée à l'insu de
    ...
    conservation et de modification des données vis à vis de l'user du site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>.</p>
...
<p>
    ...
    par l’user (ii) de l’impossibilité pour <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> d’enregistrer ou de consulter les
    ...
    Cookies.</p>
<p>
    À tout moment, l’user peut faire le choix d’exprimer et de modifier ses souhaits en matière de Cookies. <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> pourra en outre faire Appel aux
...
<p>
    ...
    sur le Site de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> ou dans son
    Application
...
<p>
    ...
    navigation sur le Site Internet ou l’Application mobile de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>. À tout moment, l’user peut
